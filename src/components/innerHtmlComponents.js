...
const productsHtmlComponent = `
  <h2 class="products__title visually-hidden">Горные лыжи</h2>
  ...
  <ul class="products__list">
    ...
    <li class="products__item">
      <article class="products__card">
        <a href="#" class="products__card-link">
          <img class="products__card-image" src="/img/snow-ekip-01.jpg" alt="Фото зимней экипировки">
        ...
        <div class="products__card-info">
          <h3 class="products__card-title">Горные лыжи</h3>
          <p class="products__card-price">5&nbsp;000&nbsp;₽</p>
        </div>
    ...
    <li class="products__item">
      <article class="products__card">
        <a href="#" class="products__card-link">
          <img class="products__card-image" src="/img/snow-ekip-02.jpg" alt="Фото зимней экипировки">
          <button class="products__card-like">
        ...
        <div class="products__card-info">
          <h3 class="products__card-title">Горные лыжи</h3>
          <p class="products__card-price">5000&nbsp;₽</p>
        </div>
    ...
    <li class="products__item">
      <article class="products__card">
        <a href="#" class="products__card-link">
          <img class="products__card-image" src="/img/snow-ekip-03.jpg" alt="Фото зимней экипировки">
          <button class="products__card-like">
            <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.41301 12.8733C8.18634 12.9533 7.81301 12.9533 7.58634 12.8733C5.65301 12.2133 1.33301 9.45998 1.33301 4.79332C1.33301 2.73332 2.99301 1.06665 5.03967 1.06665C6.25301 1.06665 7.32634 1.65332 7.99967 2.55998C8.67301 1.65332 9.75301 1.06665 10.9597 1.06665C13.0063 1.06665 14.6663 2.73332 14.6663 4.79332C14.6663 9.45998 10.3463 12.2133 8.41301 12.8733Z" fill="white" stroke="#1C1C1C" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>                      
    ...
    <li class="products__item">
      <article class="products__card">
        <a href="#" class="products__card-link">
          <img class="products__card-image" src="/img/snow-ekip-04.jpg" alt="Фото зимней экипировки">
          <button class="products__card-like">
            <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.41301 12.8733C8.18634 12.9533 7.81301 12.9533 7.58634 12.8733C5.65301 12.2133 1.33301 9.45998 1.33301 4.79332C1.33301 2.73332 2.99301 1.06665 5.03967 1.06665C6.25301 1.06665 7.32634 1.65332 7.99967 2.55998C8.67301 1.65332 9.75301 1.06665 10.9597 1.06665C13.0063 1.06665 14.6663 2.73332 14.6663 4.79332C14.6663 9.45998 10.3463 12.2133 8.41301 12.8733Z" fill="white" stroke="#1C1C1C" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>                      
...
export {
  headerHtmlComponent,
  footerHtmlComponent,
  catalogHtmlComponent,
  breadcrumbsHtmlComponent,
  productsHtmlComponent,
